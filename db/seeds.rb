...
<li>Collections publiques et privées : Banque d’œuvres d’art du Canada, Bombardier, Loto-Québec, Labidéeclic, villes d’Ottawa et de Gatineau.</li>
  ...
  {first_name: "Doris", last_name: "Lamontagne", bio: %{<p>J’ai fait mes études en Arts plastiques au Cegep de Ste-Foy, puis j’ai poursuivi un Bac en communications visuelles à l’université Laval et à l’université de l’Alberta à Edmonton. Après mon Bac, j’ai travaillé en design à Edmonton pendant trois ans puis je me suis établie à Montréal où j’ai ouvert un studio de design qui a été en opération pendant plus de 8 ans. Cette entreprise d’affaire m’a valu le prix Banque Nationale pour jeunes entrepreneur en 1991.</p>
<p>De Montréal, je suis allée vivre à Pittsburgh PA, où avant de poursuivre une maitrise en design visuel et interaction à l’université Carnegie Mellon, j’ai enseigné le design graphique numérique à l’Institut des Arts de Pittsburgh. À l’obtention de ma maitrise, je me suis établie à Ottawa où j’ai travaillé comme chercheuse en design visuel et d’interaction pour le laboratoire de recherche de Nortel Telecom. Pendant ces cinq ans, j’ai obtenu deux brevets d’invention : un pour la conception d’un système de vidéo conférence adapté à la télémédecine, l’autre pour une interface d’écran tactile intégrée aux technologies multimédias (Multi-service user interface US 6313853 B1).</p>
<p>
Après Nortel, j’ai opté pour un retour aux arts visuels et je me consacre à ma création artistique en arts photographiques et numériques. Depuis 10 ans, j’expose mes œuvres dans différentes galeries de la région ainsi qu’aux États-Unis. J’ai été récipiendaire de bourses du Conseil des Arts des arts de l’Ontario et j’ai participé à différents jurys d’exposition. Je suis active avec différents groupes artistiques (Voix Visuelle, Galerie SAW, BRAVO CARFAC). Je participe régulièrement à des discussions et conférences sur l’avenir des arts : Sommet sur les arts visuels, table-ronde, Ottawa 2008, Conférence des collectifs et des centres d’artistes autogérés, Ottawa 2008, Construction créative symposium international, Ottawa 2008, Innovation Ottawa 2011, Creative Cities Summit: Recalculating Culture in a Digital World 2013).</p>}, city: "Gatineau", first_piece: "Bio décryptage"},
...
<p>Depuis 1997, son approche artistique s’inscrit dans une démarche contemporaine ce qui l’ amènera à participer à plusieurs expositions de groupe au Québec, en Ontario, France, au Chili, au Musée d’art contemporain, à Santiago. En 2001, la ville d’Aylmer lui offre la possibilité de réaliser une œuvre publique. Dans le cadre l’exposition INTERNATIONALE DE L’ESTAMPE NUMÉRIQUES_Ottawa, en 2006, 2007 et 2012, le jury lui décerne deux fois un premier prix et un second.</p>}, city: "Gatineau", first_piece: "Inclassable", second_piece: "Les tricoteuses"},
  ...
  {first_name: "Paula", last_name: "Franzini", bio: %{<p>Paula Franzini est née à New York et a vécu aux États-Unis et en Europe avant de s’installer en Québec. Elle a déménagé à Montréal en 1997, et plus récemment à Gatineau, près d’Ottawa. Elle est diplômée d’un doctorat en physique des particules élémentaires de l’Université de Stanford, et a travaillé dans les laboratoires de renommée mondiale en tant que physicienne avant de devenir artiste à temps plein (graveur et peintre). Elle a étudié la peinture et le dessin à Ar.Co, à Lisbonne, au Portugal et au Saidye Bronfman École des Beaux-Arts, à Montréal.</p>
<p>Depuis 1998, elle est membre du collectif Montréalais de l’art imprimé l’Atelier Circulaire, où elle a siégé au conseil d’administration pendant deux ans. Depuis 2009, elle est devenue un membre actif du centre d’artistes Voix Visuelle à Ottawa, où elle est actuellement vice-présidente, et où elle est également impliquée dans le travail de coordination et de soutien technique. Elle a participé à plusieurs expositions, tant au Canada qu’à l’étranger, et ses œuvres font partie de plusieurs collections privées et corporatives. Elle a reçu des bourses du Conseil des arts de l’Ontario pour la recherche et la création, et pour l’aide aux expositions. Son chemin multidisciplinaire – elle s’intéresse à maints sujets incluant les mathématiques, l’informatique, les sciences naturelles, la photographie, la littérature, et les langues – est une partie intégrante de son travail artistique.</p>}, city: "Gatineau", first_piece: "Rupture", second_piece: "Vision Nocturne"},
